...
(* OASIS_START *)
(* DO NOT EDIT (digest: 727b3a1d7db217326115a7b225ae094c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/riscv";
          synopsis = "RISCV instruction set tools";
          description = Some [OASISText.Para "RISCV instruction set tools"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("re", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "genops.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/riscv.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/riscv";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\157\028\\p\232Ubs[\185\193\027\198\172\184Q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
